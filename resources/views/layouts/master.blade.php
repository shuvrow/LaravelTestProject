...
<div class="wrapper">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li><!-- start message -->
                                        <a href="{{asset('#')}}">
                                            <div class="pull-left">
                                                <img src="{{asset('dist/img/user5-128x128.jpg')}}" class="img-circle" alt="User Image">
                                            </div>
                                            <p> {!! $message->message !!}</p>
                                        </a>
                                    </li>
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs pull-right">
                            <li class="active"><a href="{{asset('#revenue-chart')}}" data-toggle="tab">Area</a></li>
                            <li><a href="{{asset('#sales-chart')}}" data-toggle="tab">Donut</a></li>
                    ...
                    <div class="box box-info">
                        ...
                        <form action="{!! url('Users/sentmessage') !!}" method="post">
                        <div class="box-body">

                                <div class="form-group">
                                    {{--<input type="email" class="form-control" name="emailto" placeholder="Email to:">--}}
                                    {!! Form::email('message_to','',array('class'=>'form-control','placeholder'=>'Message To')) !!}
                                </div>
                                {{--<div class="form-group">
                                ...
                                <div>
                                    ...
                                    {!!  Form::textarea('message','',array('class'=>'textarea','style'=>'width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;'))!!}
                                </div>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2015 <a href="{{asset('http://almsaeedstudio.com')}}">Almsaeed Studio</a>.</strong> All rights
        reserved.
    </footer>
            ...
            <div class="tab-pane" id="control-sidebar-settings-tab">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label class="control-sidebar-subheading">
                            Delete chat history
                            <a href="{{asset('javascript::;')}}" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
                        </label>
                    </div>
                    <!-- /.form-group -->
                </form>
